...
public class LaptopAndNotebookPageSteps {
    ...
    public void iFilledAllMandatoryFieldOfCheckoutPage() {
        new CheckoutPage().enterFirstName("Ajay");
        new CheckoutPage().enterLastName("Pandya");
        new CheckoutPage().enterEmailId("Ajay");
        new CheckoutPage().enterTelephone("077123456");
        new CheckoutPage().enterAddressLine1("29,Ohio road");
        new CheckoutPage().enterCity("London");
        new CheckoutPage().enterPostCode("wd25 7he");
